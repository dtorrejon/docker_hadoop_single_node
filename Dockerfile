...
#HADOOP CONFIG FILES
COPY /vol/xml/core-site.xml /opt/hadoop-3.2.0/etc/hadoop/
COPY /vol/xml/hdfs-site.xml /opt/hadoop-3.2.0/etc/hadoop/
COPY /vol/runscript.sh /root/
...
RUN cat jdk-12.0.1_linux-x64_bin.rpm-* >> jdk-12.0.1_linux-x64_bin.rpm \
